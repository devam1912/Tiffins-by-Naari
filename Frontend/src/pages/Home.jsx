...
export default function Home() {
  ...
  const steps = [
    { number: "1", icon: "🔍", title: "Pick a Kitchen", desc: "Browse home chefs based on cuisine, distance, and reviews.", delay: 0 },
    { number: "2", icon: "📋", title: "Choose a Plan", desc: "Select daily, weekly, or monthly meal plans that fit your life.", delay: 120 },
    { number: "3", icon: "🍽️", title: "Enjoy Daily", desc: "Fresh, home-cooked goodness delivered to your door every single day.", delay: 240 },
  ];
      ...
      <section style={{ minHeight: "100vh", padding: "0 48px", paddingTop: 90, display: "flex", alignItems: "center", background: "#E7E6B6", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, maxWidth: 620, position: "relative", zIndex: 2 }}>
          <div style={{
            ...
            🏠 Home-cooked &amp; fresh · Delivered daily in your city
          </div>
          ...
          {/* Search bar */}
          <div style={{ display: "flex", background: "#fff", borderRadius: 18, padding: "6px 6px 6px 20px", boxShadow: "0 8px 32px rgba(100,130,80,0.14)", border: "1.5px solid rgba(143,174,142,0.3)", maxWidth: 430, marginBottom: 28, ...h(420) }}>
            <span style={{ fontSize: 18, marginRight: 10, display: "flex", alignItems: "center" }}>📍</span>
          ...
          <div style={{ ...h(520), display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <a href="#for-chefs" style={{ color: "#5a7a50", fontWeight: 700, fontSize: 14, borderBottom: "2px solid #8FAE8E", paddingBottom: 1 }}>
              List your kitchen →
            </a>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center", maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div ref={whyImgRef} style={{ display: "flex", flexDirection: "column", gap: 20, alignItems: "center", opacity: whyImgInView ? 1 : 0, transform: whyImgInView ? "translateX(0)" : "translateX(50px)", transition: "all 0.8s cubic-bezier(.22,.68,0,1.2) 0.2s" }}>
            ...
            <div style={{ display: "flex", gap: 14 }}>
              {[{ icon: "🌿", text: "No Preservatives" }, { icon: "🏠", text: "Made at Home" }].map(({ icon, text }) => (
            ...
            <div ref={r} style={{
              ...
              <div style={{ position: "relative" }}>
                ...
                <div style={{
                  ...
                  <div style={{ width: 42, height: 42, borderRadius: "50%", background: "linear-gradient(135deg, #8FAE8E, #8FA873)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}>👩‍🍳</div>
                  <div>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 36 }}>
                  {[
                    { icon: "📋", text: "Set your own menu and delivery schedule" },
                    { icon: "💰", text: "Earn consistently through subscriptions" },
                    { icon: "🤝", text: "We handle discovery — you focus on cooking" },
                  ].map(({ icon, text }) => (
                    <div key={text} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                      <div style={{ width: 38, height: 38, borderRadius: 12, background: "rgba(143,174,142,0.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}>{icon}</div>
                ...
                <Link to="/signup">
                  <button
                    style={{ background: "linear-gradient(135deg, #8FAE8E, #8FA873)", color: "#fff", border: "none", borderRadius: 16, padding: "14px 32px", fontWeight: 800, fontSize: 15, cursor: "pointer", fontFamily: "'Nunito', sans-serif", boxShadow: "0 4px 20px rgba(143,174,142,0.4)", transition: "all 0.25s ease" }}
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2.2fr 1fr 1fr 1.4fr", gap: 56, paddingBottom: 56, borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                {[
                  { icon: "✉️", text: "tiffinsbynaari@gmail.com" },
                  { icon: "📍", text: "Gujarat, India" },
                  { icon: "📞", text: "+91 93281 20975" },
                ].map(({ icon, text }) => (
              ...
              <div style={{ marginTop: 28, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: "14px 16px" }}>
                ...
                <div style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.7)" }}>📱 Coming Soon on iOS & Android</div>
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: "24px 0 32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
            <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 13 }}>
              © 2026 Tiffins-By-Naari · Built with ❤️ for home food lovers
            </p>
